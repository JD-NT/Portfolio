            ...
            <footer id='footer' className='layout-case footer-section footer-layout'>
                ...
                <div className='links2'>
                    <div className='flex'><small>Social Media:</small> <div className='hazard-background-thin flex-grow-1 self-center'></div></div>
                        <a className='social-link'><Image src='/assets/bluesky.webp' className='icon' width={16} height={16} alt=''/>BlueSky</a>
                        <a className='social-link'><Image src='/assets/twitter.webp' className='icon' width={16} height={16} alt=''/>X</a>
                </div>
