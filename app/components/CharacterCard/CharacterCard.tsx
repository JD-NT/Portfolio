        ...
        <>
            <div>
                <div className='character-card'>
                    ...
                    <div className='bounding-box-L my-[1em]'><Image className='grid-bg profile-img' draggable='false' src={props.imageSrc} width={320} height={320} quality={100} alt={props.altText} unoptimized/></div>
                    </div>
                <a href={props.linkto}>
